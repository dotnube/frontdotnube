    ...
    return newRequire;
            ...
            function shimGetStats(window) {
                ...
                window.RTCPeerConnection.prototype.getStats = function getStats() {
                    var _this5 = this;
                    var selector = arguments[0], onSucc = arguments[1], onErr = arguments[2]; // If selector is a function then we are in the old style stats so just
            ...
            function shimPeerConnection(window) {
                ...
                window.RTCPeerConnection.prototype.getStats = function getStats() {
                    var selector = arguments[0], onSucc = arguments[1], onErr = arguments[2];
